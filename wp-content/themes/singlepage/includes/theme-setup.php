...
add_action( 'after_setup_theme', 'singlepage_setup' );
 ...
 function singlepage_custom_scripts(){
	...
	wp_enqueue_style( 'singlepage-main', get_stylesheet_uri(), array(), '1.0.2' );
	...
	wp_enqueue_script( 'singlepage-main', get_template_directory_uri().'/js/common.js', array( 'jquery' ), '1.0.2 ', true );
